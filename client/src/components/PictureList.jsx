  ...
  render() {
    ...
    if (pictureArray.length > 5) {
      if (initialArrowCounter === 0) {
        ...
        bottomArrow = <FiChevronDown className='arrow' id='bottom' color='#808080' onClick={(e) => {changeFivePictures(e); this.addSlideDown();}} />;
      } else {
        if (topArrowDarken) {
          topArrow = <FiChevronUp className='arrow' id='top' color='#808080' onClick={(e) => {changeFivePictures(e); this.addSlideUp();}} />;
